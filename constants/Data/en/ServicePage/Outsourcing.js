export const OUTSOURCING_PAGE_DATA = {
  headTitle: "Software Outsourcing | Logix Technology",
  ...
  whyOutsourcing: {
    title: "Why software outsourcing?",
    listContent: [
      {
        title: "Cost-saving",
        content:
      ...
      {
        title: "Quick access to industry experts & veterans",
        content:
      ...
      {
        title: "Zero distraction from business operations",
        content:
